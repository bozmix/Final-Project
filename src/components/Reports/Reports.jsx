    ...
    return (
        <>
            < div className="reportsPageDiv bg-light mb-5 pb-5" >
                {reports.map(report => {
                    return (
                        <p className="singleCompanyCandidateReport bg-white p-1 ps-3 pe-3 ms-5 me-5">
                            ...
                            <div className="col-1 text-center">
                                <button className="me-5"><i className="far fa-eye "></i></button> <button className="me-2"><i class="fas fa-times"></i></button>
                            </div>
